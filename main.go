...
func main() {
	var (
		...
		methods       = kingpin.Flag("kamailio.methods", `Comma-separated list of methods to call. E.g. "tm.stats,sl.stats". Implemented: `+strings.Join(availableMethods, ",")).Short('m').Default("mod.stats,tm.stats,sl.stats,core.shmmem,core.uptime,core.tcp_info").String()
